...
| [aws_s3_bucket_server_side_encryption_configuration.oidc](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_server_side_encryption_configuration) | resource |
| [aws_s3_bucket_versioning.oidc](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_versioning) | resource |
...
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | The name of the AWS Region this Terraform configuration will be deployed in to | `string` | n/a | yes |
